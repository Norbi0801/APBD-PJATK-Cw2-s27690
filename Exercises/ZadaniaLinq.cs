...
public sealed class ZadaniaLinq
{
    ...
    public IEnumerable<string> Zadanie04_PierwszyPrzedmiotAnalityczny()
    {
        ...
        [
            DaneUczelni.Przedmioty.Where(e => e.Kategoria == "Analytics")
                ...
                .FirstOrDefault("Brak takiego przedmiotu")
        ];
    }
    ...
    public IEnumerable<string> Zadanie05_CzyIstniejeNieaktywneZapisanie()
    {
        return
        [
            DaneUczelni.Zapisy.Any(e => !e.CzyAktywny) ? "1" : "0"
        ];
    }
    ...
    public IEnumerable<string> Zadanie06_CzyWszyscyProwadzacyMajaKatedre()
    {
        return
        [
            DaneUczelni.Prowadzacy.All(e => e.Katedra != string.Empty) ? "1" : "0"
        ];
    }
    ...
    public IEnumerable<string> Zadanie09_TrzyNajnowszeZapisy()
    {
        return DaneUczelni.Zapisy
            .OrderByDescending(e => e.DataZapisu).Take(3)
    ...
    public IEnumerable<string> Zadanie12_ParyStudentPrzedmiot()
    {
        return DaneUczelni.Zapisy
            .Join(
                ...
                z => z.StudentId,
                s => s.Id,
                (z, s) => new { s.Imie, s.Nazwisko, z.PrzedmiotId }
            ).Join(
                DaneUczelni.Przedmioty,
                sz => sz.PrzedmiotId,
                p => p.Id,
                (sz, p) => $"{sz.Imie}, {sz.Nazwisko}, {p.Nazwa}"
            );
    }
    ...
    public IEnumerable<string> Zadanie14_SredniaOcenaNaPrzedmiot()
    {
        return DaneUczelni.Zapisy
            .Join(
                ...
                sz => sz.PrzedmiotId,
                p => p.Id,
                (sz, p) => new { p.Nazwa, sz.OcenaKoncowa }
            )
            .Where(e => e.OcenaKoncowa != null)
            .GroupBy(sp => sp.Nazwa)
            .Select(sp => $"{sp.Key}, {sp.Average(e => e.OcenaKoncowa)}");
    }
    ...
    {
        return DaneUczelni.Prowadzacy.LeftJoin(
                DaneUczelni.Przedmioty,
                pr => pr.Id,
                p => p.ProwadzacyId,
            ...
            .Select(
                e => 
                $"{e.Key.Imie}, {e.Key.Nazwisko}, {e.Count(x => x.PrzedmiotId != null)}"
            );
    }
    ...
    public IEnumerable<string> Zadanie16_NajwyzszaOcenaKazdegoStudenta()
    {
        return DaneUczelni.Studenci
            ...
            .Select(e =>
                $"{e.Key.Imie}, {e.Key.Nazwisko}, {e.Max(t => t.OcenaKoncowa)}"
            );
    }
    ...
    public IEnumerable<string> Wyzwanie01_StudenciZWiecejNizJednymAktywnymPrzedmiotem()
    {
        return DaneUczelni.Studenci
            ...
            .Where(e => e.CzyAktywny)
            .GroupBy(e => new { e.Imie, e.Nazwisko })
            .Where(sp => sp.Count() > 1)
            .Select(sp => $"{sp.Key.Imie}, {sp.Key.Nazwisko}, {sp.Count()}");
    }
    ...
    public IEnumerable<string> Wyzwanie03_ProwadzacyISredniaOcenNaIchPrzedmiotach()
    {
        return DaneUczelni.Prowadzacy
            ...
            .GroupBy(e => new { e.Imie, e.Nazwisko })
            .Select(e =>
                $"{e.Key.Imie}, {e.Key.Nazwisko}, {e.Average(z => z.OcenaKoncowa)}"
            );
    }
